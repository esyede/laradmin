...
class ResourceMakeCommandTest extends AdminTestCase
{
    ...
    {
        $this
            ->artisan('admin:make-resource', ['name' => 'admin-banner'])
            ->assertExitCode(1);
    ...
    public function testFileExists()
    {
        ...
        $this->artisan('admin:make-resource', ['name' => 'admin-banner'])->assertExitCode(0);
        $this->artisan('admin:make-resource', ['name' => 'admin-banner', '--force' => true])->assertExitCode(1);
    }

    public function testMakeWithFolder()
    {
        $this->artisan('admin:make-resource', ['name' => 'api/admin/admin-banner', '--test' => true])
            ->assertExitCode(1);
