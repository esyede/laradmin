<template>
  <page-content center>
    <lz-form
      ...
      :errors.sync="errors"
    >
      <lz-form-item label="Type" prop="type" required>
      ...
      <lz-form-item label="Category" prop="category_id" required>
        <a-select
      ...
      <lz-form-item label="Name" prop="name" required>
        <a-input v-model="form.name"/>
      </lz-form-item>
      <lz-form-item label="Slug" prop="slug" required>
        <a-input v-model="form.slug"/>
      </lz-form-item>
      <lz-form-item label="Description" prop="desc">
        <a-input v-model="form.desc" type="textarea"/>
      </lz-form-item>
      <lz-form-item label="Option" prop="options">
        <type-options v-model="form.options" :type="form.type"/>
      </lz-form-item>
      <lz-form-item label="Value" prop="value">
        <type-input
          v-model="form.value"
          :type="form.type"
      ...
      <lz-form-item label="Validation" prop="validation_rules">
