<template>
  <page-content center>
    <lz-form
      ...
      :errors.sync="errors"
    >
      <lz-form-item label="Username" required prop="username">
      ...
      <lz-form-item label="Password" required-when-create prop="password">
        <a-input v-model="form.password" type="password"/>
      </lz-form-item>
      <lz-form-item label="Re-type Password" required-when-create prop="password_confirmation">
      ...
      <lz-form-item label="Permission" prop="permissions">
        <a-select
